...
public class PivotBlackBoxLibrary {
	...
	@Operation(contextual=true)
	public static Object getProperty(EStructuralFeature self) throws ParserException {
	...
	public static Object getOperation(EOperation self) throws ParserException {
		return metaModelManager.getPivotOf(org.eclipse.ocl.examples.pivot.Operation.class, self);
	}
